...
let AddAutoresComponent = class AddAutoresComponent {
    constructor(service) {
    ...
    procesarAutor() {
        ...
        this.service.addAutor(this.autor).subscribe(data => {
...
AddAutoresComponent.ctorParameters = () => [
...
let UpdateAutoresComponent = class UpdateAutoresComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ViewAutoresComponent = class ViewAutoresComponent {
    constructor(service) {
        this.service = service;
    ...
    deleteAutor(autorId) {
        this.service.deleteAutor(autorId).subscribe(datos => {
            this.actualizar();
        }, error => {
            console.log(error);
        });
...
ViewAutoresComponent.ctorParameters = () => [
    { type: src_app_share_services_autor_service__WEBPACK_IMPORTED_MODULE_3__["AutorService"] }
];
...
let AddCategoriasComponent = class AddCategoriasComponent {
    constructor(service) {
        this.service = service;
        this.message = '';
    }
    ...
    procesarAutor() {
        this.service.addCategoria(this.categoria).subscribe(data => {
...
AddCategoriasComponent.ctorParameters = () => [
...
let UpdateCategoriasComponent = class UpdateCategoriasComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ViewCategoriasComponent = class ViewCategoriasComponent {
    constructor(service) {
        this.service = service;
    ...
    deleteCategoria(categoriaId) {
        this.service.deleteCategoria(categoriaId).subscribe(datos => {
            this.actualizar();
        }, error => {
            console.log(error);
        });
...
ViewCategoriasComponent.ctorParameters = () => [
    { type: src_app_share_services_categoria_service__WEBPACK_IMPORTED_MODULE_3__["CategoriaService"] }
];
...
let AddLibroComponent = class AddLibroComponent {
    constructor(service, autorService, categoriaService) {
        this.service = service;
    ...
    ngOnInit() {
        ...
        this.autorService.findALl().subscribe(datos => {
            this.autores = datos;
        }, error => {
            console.log(error);
        });
        this.categoriaService.findALl().subscribe(datos => {
            this.categorias = datos;
        }, error => {
            console.log(error);
        });
    ...
    procesar() {
        ...
        this.service.addLibro(this.libro).subscribe(data => {
...
AddLibroComponent.ctorParameters = () => [
...
let UpdateLibroComponent = class UpdateLibroComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ViewLibrosComponent = class ViewLibrosComponent {
    constructor(service) {
        this.service = service;
        this.autor = "";
        this.categoria = "";
    ...
    deleteLibro(libroId) {
        this.service.deleteLibro(libroId).subscribe(datos => {
            this.actualizar();
        }, error => {
            console.log(error);
        });
    ...
    find() {
        this.service.find(this.nombre, this.categoria, this.autor).subscribe(datos => {
            this.libros = datos;
            this.dataSource.data = this.libros;
        }, error => {
            console.log(error);
...
ViewLibrosComponent.ctorParameters = () => [
    { type: src_app_share_services_libro_service__WEBPACK_IMPORTED_MODULE_2__["LibroService"] }
];
